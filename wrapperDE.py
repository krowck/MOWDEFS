...
temp_df = pd.read_csv("/home/gdominico/workspace/Proposta/WrapperDE-FS/RESULTS/Proposta/"+file[1]+"/selectors_silhouette_tsne2d.csv")
index = (temp_df.loc[temp_df['Weighted silhouette'].idxmax()])
print(index)
print(index[1])
#score_df = pd.read_csv("/home/gdominico/workspace/Proposta/WrapperDE-FS/RESULTS/Proposta/"+index[1], index_col=0)
