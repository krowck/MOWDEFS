dataset_file   = "Proposta/Colorectal_GSE44861/Colorectal_GSE44861.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
...
output_folder  = 'RESULTS/Proposta'        # name of directory in which the results will be saved
